...
function my_login_logo_url_title() {
    return 'Russian Linguistic Bulletin';
}
add_filter( 'login_headertitle', 'my_login_logo_url_title' );
function wps_login_message( $message ) {
    if ( empty($message) ){
        return "<p class='message'>Если у Вас возникли какие-либо проблемы относительно регистрации/логина, свяжитесь с нами по электронной почте editors[at]rulb.org.</p>";
    } else {
        return $message;
    }
}
